...
namespace WindowsFormsApp1.Calc
{
    public partial class Advertisement : Form
    {
        ...
        private void Advertisement_Load(object sender, EventArgs e)
        {
            ...
            Nowtime.Text = time;
            H.Text = (1.2).ToString();
            L.Text = (3.08).ToString();
            GCJG.Text = (5600).ToString();
            YSF.Text = (300).ToString();
            GG1.Text = (80).ToString();
            GG2.Text = (80).ToString();
            GG3.Text = (55).ToString();
            GG4.Text = (40).ToString();
            GG5.Text = (40).ToString();
            GG6.Text = (40).ToString();
            GG7.Text = (55).ToString();
            GG8.Text = (30).ToString();
            GG9.Text = (850).ToString();
            GG10.Text = (2700).ToString();
            ZC1.Text = (320).ToString();
            ZC2.Text = (171).ToString();
            ZC3.Text = (160).ToString();
            ZC4.Text = (146).ToString();
            ZC5.Text = (850).ToString();
            FH1.Text = (1.8).ToString();
            FH2.Text = (1.2).ToString();
            FH3.Text = (1).ToString();
            FH4.Text = (1.2).ToString();
            FH5.Text = (1.5).ToString();
            SL5.Text = (2.7).ToString();
            SL6.Text = (1).ToString();
            SL7.Text = (6.18).ToString();
            HBC1.Text = (0).ToString();
            HBC2.Text = (0).ToString();
            HBC3.Text = (0.05).ToString();
            HBC4.Text = (0).ToString();
            HBC5.Text = (0.3).ToString();
            FYL1.Text = (0.12).ToString();
            JEY11.Text = (59.22).ToString();
            YM2.Text = (10).ToString();
            YM3.Text = (1).ToString();
            YM5.Text = (5).ToString();
            DJY6.Text = (20).ToString();
        ...
        private void DJY5_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if ((int)e.KeyChar == 46) //小数点
            {
                ...
                else
                {
                    ...
                    float oldf;
                    bool b1 = false, b2 = false;
                    b1 = float.TryParse(DJY7.Text, out oldf);
                    b2 = float.TryParse(DJY7.Text + e.KeyChar.ToString(), out f);
                    if (b2 == false)
                    {
                        if (b1 == true)
                            e.Handled = true;
        ...
        private void DJY6_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if ((int)e.KeyChar == 46) //小数点
            {
                ...
                else
                {
                    ...
                    float oldf;
                    bool b1 = false, b2 = false;
                    b1 = float.TryParse(DJY8.Text, out oldf);
                    b2 = float.TryParse(DJY8.Text + e.KeyChar.ToString(), out f);
                    if (b2 == false)
                    {
                        if (b1 == true)
                            e.Handled = true;
        ...
        private void JEY9_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if ((int)e.KeyChar == 46) //小数点
            {
                ...
                else
                {
                    ...
                    float oldf;
                    bool b1 = false, b2 = false;
                    b1 = float.TryParse(JEY11.Text, out oldf);
                    b2 = float.TryParse(JEY11.Text + e.KeyChar.ToString(), out f);
                    if (b2 == false)
                    {
                        if (b1 == true)
                            e.Handled = true;
        ...
        private void H_TextChanged(object sender, EventArgs e)
        {
            ...
            SL1.Text = (a - 0.1).ToString();
            SL3.Text = ((a - 0.3) * 2).ToString();
        }
        ...
        private void L_TextChanged(object sender, EventArgs e)
        {
            ...
            SL2.Text = (b - 0.08).ToString();
            SL4.Text = (b - 0.08).ToString();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (FH1.Text == "" || FH2.Text == "" || FH3.Text == "" || FH4.Text == "" || FH5.Text == "" || ZC1.Text == "" || ZC2.Text == "" || ZC3.Text == "" || ZC4.Text == "" || ZC5.Text == "")
                {
                ...
                else
                {
                    ...
                    double dd = Convert.ToDouble(ZC5.Text);
                    ...
                    double ii = Convert.ToDouble(FH5.Text);
                    ...
                    double mm = Convert.ToDouble(SL5.Text);
                    MZ1.Text = (a * (f - 0.1) * 0.00785).ToString();
                    MZ2.Text = (b * (g - 0.1) * 0.00785).ToString();
                    MZ3.Text = (c * (h - 0.1) * 0.00785).ToString();
                    MZ4.Text = (d * (i - 0.1) * 0.00785).ToString();
                    MZ5.Text = (dd * ii * 0.00785).ToString();
                    SL7.Text = ((((a * j) + (b * k) + (c * l) + (d * m)) / 1000) + (dd * mm * 2 / 1000)).ToString();
                }
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    double aad = Convert.ToDouble(SL5.Text);
                    double abd = Convert.ToDouble(SL6.Text);
                    double ae = Convert.ToDouble(SL7.Text);
                    ...
                    double aai = Convert.ToDouble(MZ5.Text);
                    ...
                    double aan = Convert.ToDouble(DJY5.Text);
                    double abn = Convert.ToDouble(DJY6.Text);
                    double ao = Convert.ToDouble(DJY7.Text);
                    double ap = Convert.ToDouble(DJY8.Text);
                    ...
                    double aam = Convert.ToDouble(HBC5.Text);
                    ...
                    JEY5.Text = (aad * aai * (aan + aam)).ToString("0.00");
                    JEY6.Text = (abd * abn).ToString("0.00");
                    JEY7.Text = (ae * ao).ToString("0.00");
                    ...
                    double aag = Convert.ToDouble(JEY5.Text);
                    double bg = Convert.ToDouble(JEY6.Text);
                    double h = Convert.ToDouble(JEY7.Text);
                    JEY8.Text = (((c + d + f + g + h + aag + bg) / 0.95) * ap).ToString("0.00");
                    double i = Convert.ToDouble(JEY8.Text);
                    JEY9.Text = (c + d + f + g + h + aag + bg + i).ToString();
                    double j = Convert.ToDouble(JEY9.Text);
                    JEY10.Text = (j / ll).ToString("0.00");

                    double l = Convert.ToDouble(JEY10.Text);

                    double n = Convert.ToDouble(JEY11.Text);

                    JEY12.Text = (n / ll).ToString("0.00");

                    double m = Convert.ToDouble(JEY12.Text);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                YM4.Text = (((a + b + c) / (1 - d)) * d).ToString("0.00");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            //
            //项目名称的定义
            string ba = MC1.Text; string bb = MC2.Text; string bc = MC3.Text; string bd = MC4.Text; string be = MC5.Text; string bf = MC6.Text; string bg = MC7.Text; string bh = MC8.Text; string bi = MC10.Text; string bj = MC12.Text; string bk = MC19.Text; string bl = MC20.Text;
            //主内容定义
            string ca = JEY1.Text; string cb = JEY2.Text; string cc = JEY3.Text; string cd = JEY4.Text; string ce = JEY5.Text; string cf = JEY6.Text; string cg = JEY7.Text; string ch = JEY8.Text; string ci = JEY10.Text; string cj = JEY12.Text; string ck = YM6.Text; string cl = YM7.Text;
