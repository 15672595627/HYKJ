...
{
    public partial class Air1 : Form
    {
        public Air1()
        {
            InitializeComponent();
        ...
        private void H_TextChanged(object sender, EventArgs e)
        {
            ...
            SL2.Text = (a - 0.032).ToString();
            SL4.Text = ((a - 0.1) * 13).ToString();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    JEY10.Text = ((n / ll) - 2.5).ToString("0.00");
