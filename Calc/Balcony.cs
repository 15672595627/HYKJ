...
{
    public partial class Balcony : Form
    {
        public Balcony()
        {
            InitializeComponent();
        ...
        private void Balcony_Load(object sender, EventArgs e)
        {
            string time = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
            Nowtime.Text = time;
            H.Text = (1.1).ToString();
            L.Text = (2.32).ToString();
            GCJG.Text = (5300).ToString();
        ...
        private void H_TextChanged(object sender, EventArgs e)
        {
            ...
            SL4.Text = ((a - 0.2 - 0.04) * 14).ToString();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            //
            //项目名称的定义
            string ba = MC1.Text; string bb = MC2.Text; string bc = MC3.Text; string bd = MC4.Text; string be = MC5.Text; string bf = MC6.Text; string bg = MC8.Text; string bh = MC10.Text; string bi = MC19.Text; string bj = MC20.Text;
            //主内容定义
