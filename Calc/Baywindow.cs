...
{
    public partial class Baywindow : Form
    {
        public Baywindow()
        {
            InitializeComponent();
        ...
        private void Baywindow_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    JEY10.Text = ((n / ll) - 1).ToString("0.00");
