...
{
    public partial class Beijing : Form
    {
        public Beijing()
        {
            InitializeComponent();
        ...
        private void Beijing_Load(object sender, EventArgs e)
        {
            ...
            GG3.Text = (16).ToString();
            GG4.Text = (16).ToString();
            GG5.Text = (63).ToString();
            GG6.Text = (35).ToString();

            ZC1.Text = (320).ToString();
            ZC2.Text = (50).ToString();
            ZC3.Text = (266).ToString();

            FH1.Text = (1.8).ToString();
            FH2.Text = (0).ToString();
            FH3.Text = (2.5).ToString();

            HBC1.Text = (0).ToString();
            HBC2.Text = (0).ToString();
            HBC3.Text = (0).ToString();

            JEY8.Text = (23.56).ToString();
            ...
            YM3.Text = (1).ToString();
            YM5.Text = (5).ToString();
            DJY4.Text = (7.5).ToString();
            DJY5.Text = (0.05).ToString();
        }
        ...
        private void DJY5_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if ((int)e.KeyChar == 46) //小数点
            {
                ...
                else
                {
                    ...
                    float oldf;
                    bool b1 = false, b2 = false;
                    b1 = float.TryParse(DJY4.Text, out oldf);
                    b2 = float.TryParse(DJY4.Text + e.KeyChar.ToString(), out f);
                    if (b2 == false)
                    {
                        if (b1 == true)
                            e.Handled = true;
        ...
        private void JEY9_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if ((int)e.KeyChar == 46) //小数点
            {
                ...
                else
                {
                    ...
                    float oldf;
                    bool b1 = false, b2 = false;
                    b1 = float.TryParse(JEY8.Text, out oldf);
                    b2 = float.TryParse(JEY8.Text + e.KeyChar.ToString(), out f);
                    if (b2 == false)
                    {
                        if (b1 == true)
                            e.Handled = true;
        ...
        private void H_TextChanged(object sender, EventArgs e)
        {
            ...
            SL2.Text = (((a - 0.2) * 2 + 0.1) * 11).ToString();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (FH1.Text == "" || FH2.Text == "" || FH3.Text == "" || ZC1.Text == "" || ZC2.Text == "" || ZC3.Text == "")
                {
                ...
                else
                {
                    ...
                    SL4.Text = (((a * j) + (b * k) + (c * l)) / 1000).ToString();
                }
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    double ap = Convert.ToDouble(DJY5.Text);
                    ...
                    JEY5.Text = (((c + d + f + g) / 0.95) * ap).ToString("0.00");
                    double aag = Convert.ToDouble(JEY5.Text);
                    JEY6.Text = (c + d + f + g + aag).ToString();
                    double j = Convert.ToDouble(JEY6.Text);
                    JEY7.Text = (j / ll).ToString("0.00");

                    double l = Convert.ToDouble(JEY7.Text);

                    double n = Convert.ToDouble(JEY8.Text);

                    JEY9.Text = (n / ll).ToString("0.00");

                    double m = Convert.ToDouble(JEY9.Text);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            //
            //项目名称的定义
            string ba = MC1.Text; string bb = MC2.Text; string bc = MC3.Text; string bd = MC4.Text; string be = MC5.Text; string bf = MC7.Text; string bg = MC9.Text; string bh = MC15.Text; string bi = MC16.Text;
            //主内容定义
            string ca = JEY1.Text; string cb = JEY2.Text; string cc = JEY3.Text; string cd = JEY4.Text; string ce = JEY5.Text; string cf = JEY7.Text; string cg = JEY9.Text; string ci = YM6.Text; string cj = YM7.Text;
            string da = GG1.Text; string db = GG2.Text; string dc = GG3.Text; string dd = GG4.Text; string de = GG5.Text; string df = GG6.Text;
            string aa = ZC1.Text; string ab = ZC2.Text; string ac = ZC3.Text;
            string ea = FH1.Text; string eb = FH2.Text; string ec = FH3.Text;
            string fa = SL1.Text; string fb = SL2.Text; string fc = SL3.Text; string fd = SL4.Text;
            string ga = MZ1.Text; string gb = MZ2.Text; string gc = MZ3.Text;
            string ha = DJY1.Text; string hb = DJY2.Text; string hc = DJY3.Text; string hd = DJY4.Text; string he = DJY5.Text;
            string ia = HBC1.Text; string ib = HBC2.Text; string ic = HBC3.Text;
            ...
            cmd.CommandText = "INSERT INTO [dbo].[Price_b] ([Uid],[Project],[Quantity],[Unitprice],[Amount]) VALUES ('" + a + "','" + bd + "','" + fd + "','" + hd + "','" + cd + "')";

            int count5 = cmd.ExecuteNonQuery();

            cmd.CommandText = "INSERT INTO [dbo].[Price_b] ([Uid],[Project],[Unitprice],[Amount]) VALUES ('" + a + "','" + be + "','" + he + "','" + ce + "')";

            int count6 = cmd.ExecuteNonQuery();
            cmd.CommandText = "INSERT INTO [dbo].[Price_b] ([Uid],[Project],[Amount]) VALUES ('" + a + "','" + bf + "','" + cf + "')";
            ...
            cmd.CommandText = "INSERT INTO [dbo].[Price_b] ([Uid],[Project],[Amount]) VALUES ('" + a + "','" + bh + "','" + ci + "')";

            int count9 = cmd.ExecuteNonQuery();
            cmd.CommandText = "INSERT INTO [dbo].[Price_b] ([Uid],[Project],[Amount]) VALUES ('" + a + "','" + bi + "','" + cj + "')";
            ...
            if (count > 0 || count1 > 0 || count2 > 0 || count3 > 0 || count5 > 0 || count6 > 0 || count7 > 0 || count8 > 0 || count9 > 0 || count10 > 0 || count11 > 0)
            {
