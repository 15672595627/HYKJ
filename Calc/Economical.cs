...
{
    public partial class Economical : Form
    {
        public Economical()
        {
            InitializeComponent();
        ...
        private void Economical_Load(object sender, EventArgs e)
        {
        ...
        private void H_TextChanged(object sender, EventArgs e)
        {
            ...
            SL3.Text = ((a - 0.32 - 0.035 * 2) * 13).ToString();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    JEY10.Text = ((n / ll) - 2).ToString("0.00");
