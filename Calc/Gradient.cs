...
namespace WindowsFormsApp1.Calc
{
    public partial class Gradient : Form
    {
        ...
        private void Gradient_Load(object sender, EventArgs e)
        {
            ...
            GG5.Text = (50).ToString();
            GG6.Text = (30).ToString();
            GG7.Text = (55).ToString();
            GG8.Text = (30).ToString();

            ZC1.Text = (320).ToString();
            ZC2.Text = (174).ToString();
            ZC3.Text = (127).ToString();
            ...
            JEY9.Text = (68.69).ToString();

            FYL1.Text = (0.12).ToString();

            YM2.Text = (10).ToString();
            YM3.Text = (11).ToString();
            YM5.Text = (5).ToString();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            //
            //项目名称的定义
            string ba = MC1.Text; string bb = MC2.Text; string bc = MC3.Text; string bd = MC4.Text; string be = MC5.Text; string bf = MC6.Text; string bg = MC8.Text; string bh = MC10.Text; string bi = MC16.Text; string bj = MC17.Text;
            //主内容定义
            string ca = JEY1.Text; string cb = JEY2.Text; string cc = JEY3.Text; string cd = JEY4.Text; string ce = JEY5.Text; string cf = JEY6.Text; string cg = JEY8.Text; string ch = JEY10.Text; string ci = YM6.Text; string cj = YM7.Text;
