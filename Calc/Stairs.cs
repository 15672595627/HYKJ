...
{
    public partial class Stairs : Form
    {
        public Stairs()
        {
            InitializeComponent();
        ...
        private void Stairs_Load(object sender, EventArgs e)
        {
        ...
        private void H_TextChanged(object sender, EventArgs e)
        {
            ...
            SL4.Text = ((a - 0.2 - 0.04) * 18).ToString();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    JEY10.Text = ((n / ll) - 5.5).ToString("0.00");
