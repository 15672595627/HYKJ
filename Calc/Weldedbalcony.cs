...
{
    public partial class Weldedbalcony : Form
    {
        public Weldedbalcony()
        {
            InitializeComponent();
        }
        ...
        private void Weldedbalcony_Load(object sender, EventArgs e)
        {
            ...
            FH1.Text = (2.0).ToString();
            FH2.Text = (3.0).ToString();
            FH3.Text = (2.0).ToString();
            FH4.Text = (1.0).ToString();

            HBC1.Text = (0.1).ToString();
            HBC2.Text = (0.65).ToString();
            HBC3.Text = (0.1).ToString();
            HBC4.Text = (0.15).ToString();

            JEY9.Text = (12.62).ToString();

            FYL1.Text = (0.12).ToString();
            FYL2.Text = (0.05).ToString();
            YM2.Text = (15.6).ToString();
            YM3.Text = (10).ToString();
            YM7.Text = (2).ToString();
        ...
        private void H_TextChanged(object sender, EventArgs e)
        {
            ...
            SL4.Text = ((a - 0.2 - 0.04 - 0.032 * 2) * 14).ToString();
        }
