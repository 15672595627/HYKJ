...
{
    public partial class Weldedgrass : Form
    {
        public Weldedgrass()
        {
            InitializeComponent();
        ...
        private void Weldedgrass_Load(object sender, EventArgs e)
        {
            string time = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
            Nowtime.Text = time;
            H.Text = (1.1).ToString();
            L.Text = (2.32).ToString();
            GCJG.Text = (5600).ToString();
            YSF.Text = (300).ToString();
            GG1.Text = (40).ToString();
            GG2.Text = (80).ToString();
            GG3.Text = (40).ToString();
            ...
            ZC1.Text = (207).ToString();
            ZC2.Text = (160).ToString();
            ZC3.Text = (146).ToString();
            ZC4.Text = (76).ToString();

            FH1.Text = (1.5).ToString();
            FH2.Text = (1.5).ToString();
            ...
            HBC3.Text = (0.55).ToString();
            HBC4.Text = (0).ToString();

            JEY9.Text = (14.42).ToString();

            FYL1.Text = (0.12).ToString();
            FYL2.Text = (0.05).ToString();
            YM2.Text = (5.43).ToString();
            YM3.Text = (6).ToString();
            YM7.Text = (2).ToString();
            DJY5.Text = (8).ToString();
        ...
        private void L_TextChanged(object sender, EventArgs e)
        {
            ...
            SL1.Text = (b).ToString();
            SL3.Text = ((b - 0.2 - 0.04 * 3) * 2).ToString();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            //
            //项目名称的定义
            string ba = MC1.Text; string bb = MC2.Text; string bc = MC3.Text; string bd = MC4.Text; string be = MC5.Text; string bf = MC6.Text; string bg = MC7.Text; string bh = MC10.Text; string bi = MC18.Text; string bj = MC19.Text;
            //主内容定义
