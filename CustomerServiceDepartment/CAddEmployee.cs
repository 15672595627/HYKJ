...
{
    public partial class CAddEmployee : Form
    {
        public CAddEmployee()
        {
            InitializeComponent();
        ...
        private void CAddEmployee_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void CAddEmployee_SizeChanged(object sender, EventArgs e)
        {
