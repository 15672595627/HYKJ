...
{
    public partial class CCGXBudgetList : Form
    {
        public CCGXBudgetList()
        {
            InitializeComponent();
        }
        ...
        private void CCGXBudgetList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void CCGXBudgetList_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                ...
                cmd.CommandText = "update KFBcgxys set  state = -1 where id = '" + id + "'";
