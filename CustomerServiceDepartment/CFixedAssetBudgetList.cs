...
{
    public partial class CFixedAssetBudgetList : Form
    {
        public CFixedAssetBudgetList()
        {
            InitializeComponent();
        }
        ...
        private void CFixedAssetBudgetList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void CFixedAssetBudgetList_SizeChanged(object sender, EventArgs e)
        {
        ...
        {
            string str = "select [id],[apartment] as 部门,[name] as 名称,[purpose] as 用途,[price] as 单价,[number] as 数量,[date] as 月份, [state] as 状态 from KFBFixedAssetBudget where date like '%" + dateTimePicker1.Text.Trim() + "%' and state = 1 order by date desc";
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            CUpdateFixedAssetBudget updateCGXBBudget = new CUpdateFixedAssetBudget();
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                ...
                cmd.CommandText = "update KFBFixedAssetBudget set  state = -1 where id = '" + id + "'";
