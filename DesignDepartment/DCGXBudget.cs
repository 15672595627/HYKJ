...
{
    public partial class DCGXBudget : Form
    {
        public DCGXBudget()
        {
            InitializeComponent();
        ...
        private void DCGXBudget_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void DCGXBudget_SizeChanged_1(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id,date as 时间 ,state as 状态 from SJBcgxys";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                if (rq == date && zt == 1)
                {
                    ...
                    {
                        DUpdateCGXBudget updateCGXBBudget = new DUpdateCGXBudget();
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[SJBcgxys]([employee], [monthlySigningAmountPerEmployee], [signingTarget], [OrderTarget],[shippingTarget], [paymentTarget], [deposit ], [currentMonthShipmentReceipt], [collectionEarlyArrears], [refundAccounts],[date],[state]) VALUES ('" + ygrs + "', '" + zyrj + "', '" + qdmb + "','" + xdmb + "', '" + chmb + "', '" + hkmb + "', '" + dj + "', '" + bych + "', '" + sqqqk + "', '" + tgzk + "','" + date + "',1)";
