...
{
    public partial class DCGXBudgetList : Form
    {
        public DCGXBudgetList()
        {
            InitializeComponent();
        }
        ...
        private void DCGXBudgetList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void DCGXBudgetList_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                ...
                cmd.CommandText = "update SJBcgxys set  state = -1 where id = '" + id + "'";
