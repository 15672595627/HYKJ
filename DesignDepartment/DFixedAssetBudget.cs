...
{
    public partial class DFixedAssetBudget : Form
    {
        public DFixedAssetBudget()
        {
            InitializeComponent();
        }
        ...
        DataTable dt;
        SqlDataAdapter da;
        private void DFixedAssetBudget_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void DFixedAssetBudget_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id,date as 时间,state as 状态 from SJBFixedAssetBudget";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                if (rq == date && zt == 1)
                {
                    ...
                    {
                        DUpdateFixedAssetBudget updateCGXBBudget = new DUpdateFixedAssetBudget();
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[SJBFixedAssetBudget]([apartment], [name], [purpose], [price], [number], [date],state) VALUES ('" + bm + "', '" + xm + "', '" + yt + "', '" + dj + "', '" + sl + "', '" + date + "',1)";
