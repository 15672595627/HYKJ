...
{
    public partial class EAddEmployee : Form
    {
        public EAddEmployee()
        {
            InitializeComponent();
        ...
        private void EAddEmployee_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void EAddEmployee_SizeChanged(object sender, EventArgs e)
        {
