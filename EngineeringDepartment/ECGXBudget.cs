...
{
    public partial class ECGXBudget : Form
    {
        public ECGXBudget()
        {
            InitializeComponent();
        ...
        private void ECGXBudget_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void ECGXBudget_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id,date as 时间 ,state as 状态 from GCBcgxys";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[GCBcgxys]([employee], [monthlySigningAmountPerEmployee], [signingTarget], [OrderTarget],[shippingTarget], [paymentTarget], [deposit ], [currentMonthShipmentReceipt], [collectionEarlyArrears], [refundAccounts],[date],[state]) VALUES ('" + ygrs + "', '" + zyrj + "', '" + qdmb + "','" + xdmb + "', '" + chmb + "', '" + hkmb + "', '" + dj + "', '" + bych + "', '" + sqqqk + "', '" + tgzk + "','" + date + "',1)";
