...
{
    public partial class ESalaryDetails : Form
    {
        public ESalaryDetails()
        {
            InitializeComponent();
        }
        int Iid;
        ...
        private void ESalaryDetails_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void ESalaryDetails_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id ,date as 时间 ,state as 状态 from GCBSalaryDetails";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[GCBSalaryDetails]([DepartMent], [Number], [Amount], [January], [February], [March], [April], [May], [June], [July], [August], [September], [October], [November], [December], [date], [state]) VALUES ('" + bm + "', '" + zrs + "', '" + zje + "', '" + yy + "', '" + ey + "', '" + sy + "', '" + siy + "', '" + wy + "', '" + ly + "', '" + qy + "', '" + by + "', '" + jy + "', '" + shiy + "', '" + syy + "', '" + sey + "', '" + date + "', 1)";
