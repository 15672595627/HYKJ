...
{
    public partial class ESummaryBudget : Form
    {
        public ESummaryBudget()
        {
            InitializeComponent();
        }
        ...
        private void ESummaryBudget_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void ESummaryBudget_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id ,date as 时间 ,state as 状态 from GCBBudget";
