...
{
    public partial class CWBAddEmployee : Form
    {
        public CWBAddEmployee()
        {
            InitializeComponent();
        }
        int Iid;
        ...
        private void CWBAddEmployee_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void CWBAddEmployee_SizeChanged(object sender, EventArgs e)
        {
