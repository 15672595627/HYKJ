...
{
    public partial class CWBFixedAssetBudget : Form
    {
        public CWBFixedAssetBudget()
        {
            InitializeComponent();
        }
        ...
        DataTable dt;
        SqlDataAdapter da;
        private void CWBFixedAssetBudget_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void CWBFixedAssetBudget_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id,date as 时间,state as 状态 from CWBFixedAssetBudget";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[CWBFixedAssetBudget]([apartment], [name], [purpose], [price], [number], [date],state) VALUES ('" + bm + "', '" + xm + "', '" + yt + "', '" + dj + "', '" + sl + "', '" + date + "',1)";
