...
{
    public partial class CWBUpdateBudget : Form
    {
        public CWBUpdateBudget()
        {
            InitializeComponent();
        }
        ...
        private void CWBUpdateBudget_SizeChanged(object sender, EventArgs e)
        {
