...
{
    public partial class GSummaryBudget : Form
    {
        public GSummaryBudget()
        {
            InitializeComponent();
        }
        int Iid;
        ...
        private void GSummaryBudget_Load(object sender, EventArgs e)
        {
        ...
        private void GSummaryBudget_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id ,date as 时间 ,state as 状态 from ZJBBudget";
