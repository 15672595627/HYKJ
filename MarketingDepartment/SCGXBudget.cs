...
{
    public partial class SCGXBudget : Form
    {
        public SCGXBudget()
        {
            InitializeComponent();
        ...
        private void SCGXBudget_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void SCGXBudget_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id,date as 时间 ,state as 状态 from SCBcgxys";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                if (rq == date && zt == 1)
                {
                    ...
                    {
                        SUpdateCGXBBudget updateCGXBBudget = new SUpdateCGXBBudget();
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[SCBcgxys]([employee], [monthlySigningAmountPerEmployee], [signingTarget], [shippingTarget], [paymentTarget], [deposit ], [currentMonthShipmentReceipt], [collectionEarlyArrears], [refundAccounts],[date],[state]) VALUES ('" + ygrs + "', '" + zyrj + "', '" + qdmb + "', '" + chmb + "', '" + hkmb + "', '" + dj + "', '" + bych + "', '" + sqqqk + "', '" + tgzk + "','" + date + "',1)";
