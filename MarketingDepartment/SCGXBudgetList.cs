...
{
    public partial class SCGXBudgetList : Form
    {
        public SCGXBudgetList()
        {
            InitializeComponent();
        }
        ...
        private void SCGXBudgetList_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                ...
                cmd.CommandText = "update SCBcgxys set  state = -1 where id = '" + id + "'";
        ...
        private void SCGXBudgetList_Load(object sender, EventArgs e)
        {
