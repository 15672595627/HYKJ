...
{
    public partial class SEmployeeList : Form
    {
        public SEmployeeList()
        {
            InitializeComponent();
        }
        ...
        private void SEmployeeList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void SEmployeeList_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string str = "select id,[position] as 岗位名称, [reason] as 原因, [numberPeople] as 计划入职人数, [date] as 月份 ,state2 as 状态 from [dbo].[SCBPersonnelDetails] where date like '%" + dateTimePicker1.Text.Trim() + "%' and state = 1 and state2 = 1 order by date desc";
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                ...
                cmd.CommandText = "update ZJBPersonnelDetails set  state = -1 where id = '" + id + "'";
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            {
                string iId = dataGridView1.CurrentRow.Cells["id"].Value.ToString();
                SUpdateReduceEmployee updateCGXBBudget = new SUpdateReduceEmployee();
                updateCGXBBudget.id = iId;
                updateCGXBBudget.Username = Username;
                updateCGXBBudget.Group = Group;
                updateCGXBBudget.ShowDialog();
