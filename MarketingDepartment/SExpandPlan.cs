...
{
    public partial class SExpandPlan : Form
    {
        public SExpandPlan()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id, date as 时间 ,state as 状态 from SCBExpandPlan where state = 1";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[SCBExpandPlan]([region], [province], [market], [county], [number], [yuefen], [target1], [target2], [remark], [date], [state]) VALUES ('" + qy + "', '" + sf + "', '" + s + "', '" + qx + "', '"+rs+"','"+yf+"','"+qd+"','"+ch+"','"+bz+"','"+date+"','1')";
