...
{
    public partial class SExpandPlanList : Form
    {
        public SExpandPlanList()
        {
            InitializeComponent();
        }
        ...
        private void SCBExpandPlanList_Load(object sender, EventArgs e)
        {
        ...
        {
            string str = "select id,date as 时间 , region as 区域 ,province as 省份 ,market as 市 ,county as 区县 ,number as 人数 ,yuefen as 人员到位月份 ,target1 as 签单目标,target2 as 收货目标 ,remark as 备注,state as 状态 from SCBExpandPlan where date like '%" + dateTimePicker1.Text.Trim() + "%' and state = 1 order by date desc";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                sum2 += Convert.ToInt32(dataGridView1.Rows[i].Cells[7].Value);
            ...
            string[] row = { "1", "合计", "", "", "", "", ssum1, "", ssum2, ssum3, "" };
            ((DataTable)dataGridView1.DataSource).Rows.Add(row);
        }

        private void SCBExpandPlanList_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                ...
                cmd.CommandText = "update SCBExpandPlan set  state = -1 where id = '" + id + "'";
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            SUpdateExpandPlan updateCGXBBudget = new SUpdateExpandPlan();
        ...
        private void SExpandPlanList_Load(object sender, EventArgs e)
        {
