...
{
    public partial class SGSummaryBudget : Form
    {
        public SGSummaryBudget()
        {
            InitializeComponent();
        }
        ...
        private void SGSummaryBudget_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id ,date as 时间 ,state as 状态 from SCBBudget";
        ...
        private void SGSummaryBudget_SizeChanged(object sender, EventArgs e)
        {
