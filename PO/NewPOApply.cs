...
{
    public partial class NewPOApply : Form
    {
        public NewPOApply()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string strsql = "select orderid as 单据编号,date as 日期,examine as 审核状态 from [dbo].[PurchaseApply] where examine = '已审核' and date between '" + RQ.Text.Trim() + "' and '" + RQ1.Text.Trim() + "'";
