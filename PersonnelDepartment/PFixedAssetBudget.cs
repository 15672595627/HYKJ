...
{
    public partial class PFixedAssetBudget : Form
    {
        public PFixedAssetBudget()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id,date as 时间,state as 状态 from RSBFixedAssetBudget";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[RSBFixedAssetBudget]([apartment], [name], [purpose], [price], [number], [date],state) VALUES ('" + bm + "', '" + xm + "', '" + yt + "', '" + dj + "', '" + sl + "', '" + date + "',1)";
