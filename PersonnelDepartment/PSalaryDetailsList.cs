...
{
    public partial class PSalaryDetailsList : Form
    {
        public PSalaryDetailsList()
        {
            InitializeComponent();
        }
        int cot;
        ...
        private void PSalaryDetailsList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void PSalaryDetailsList_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                ...
                cmd.CommandText = "update RSBSalaryDetails set  state = -1 where id = '" + id + "'";
