...
namespace WindowsFormsApp1.PersonnelDepartment
{
    public partial class PSummaryBudget : Form
    {
        ...
        void PSummaryBudget_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {

            {
                ...
                con.Open();
                string findSj = "select id ,date as 时间 ,state as 状态 from RSBBudget";
