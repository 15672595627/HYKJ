...
{
    public partial class PBListByMonth : Form
    {
        public PBListByMonth()
        {
            InitializeComponent();
        }
        ...
        private void PBListByMonth_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }
        private void PBListByMonth_SizeChanged(object sender, EventArgs e)
        {
