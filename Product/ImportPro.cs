...
{
    public partial class ImportPro : Form
    {
        public ImportPro()
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                con.Open();
                string myInsert = "INSERT INTO [dbo].[Stock]([date],[contractid],[product],[sub],[norm],[unit],[num],[amount],[warehouse]) VALUES('" + aa + "', '" + bb + "', '" + cc + "', '" + dd + "', '" + ee + "', '" + ff + "', '" + gg + "', '" + hh + "', '" + ii + "')";
