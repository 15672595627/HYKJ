...
namespace WindowsFormsApp1.Product
{
    public partial class ProductInCon : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            string strsql = "select orderid as 销售订单,contractid as 合同编号,company as 公司名,project as 项目名称,productname as 产品,sub as 内容,quantity as 数量,unit as 单位,price as 单价,meters as 米数,amount as 总金额,wsje as 无税金额 from [dbo].[Order_b] where productname like '%" + aa + "%' and company like '%" + bb + "%'  and project like '%" + cc + "%' ORDER BY date DESC ";
