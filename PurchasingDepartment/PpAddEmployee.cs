...
{
    public partial class PpAddEmployee : Form
    {
        public PpAddEmployee()
        {
            InitializeComponent();
        }
        int Iid;
        ...
        private void PAddEmployee_SizeChanged(object sender, EventArgs e)
        {
            asc.controlAutoSize(this);
        }

        private void PAddEmployee_Load(object sender, EventArgs e)
        {
