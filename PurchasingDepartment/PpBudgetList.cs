...
{
    public partial class PpBudgetList : Form
    {
        public PpBudgetList()
        {
            InitializeComponent();
        ...
        private void PBudgetList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void PBudgetList_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                ...
                cmd.CommandText = "update CGBcgxys set  state = -1 where id = '" + id + "'";
