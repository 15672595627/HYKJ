...
{
    public partial class PpFixedAssetBudgetList : Form
    {
        public PpFixedAssetBudgetList()
        {
            InitializeComponent();
        }
        ...
        {
            string str = "select [id],[apartment] as 部门,[name] as 名称,[purpose] as 用途,[price] as 单价,[number] as 数量,[date] as 月份, [state] as 状态 from CGBFixedAssetBudget where date like '%" + dateTimePicker1.Text.Trim() + "%' and state = 1 order by date desc";
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                ...
                cmd.CommandText = "update CGBFixedAssetBudget set  state = -1 where id = '" + id + "'";
