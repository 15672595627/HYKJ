...
namespace WindowsFormsApp1.PurchasingDepartment
{
    public partial class PReduceEmployee : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select ID,date as 时间 ,state as 状态 from CGBPersonnelDetails where state = -1";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[CGBPersonnelDetails]([position], [reason], [numberPeople], [date], [state],state2) VALUES ('" + zw + "', '" + yy + "', '" + sl + "', '" + date + "', '-1',1)";
