...
{
    public partial class JZQYAddEmployee : Form
    {
        public JZQYAddEmployee()
        {
            InitializeComponent();
        }
        ...
        private void JZQYAddEmployee_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void JZQYAddEmployee_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id, date as 时间 ,state as 状态 from SalesPersonnelDetails where state = 1 and company = '荆州区域'";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[SalesPersonnelDetails]([position], [reason], [numberPeople], [date], [state],state2,[company]) VALUES ('" + zw + "', '" + yy + "', '" + sl + "', '" + date + "', '1','1','荆州区域')";
