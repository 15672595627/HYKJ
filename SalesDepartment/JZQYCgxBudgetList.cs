...
{
    public partial class JZQYCgxBudgetList : Form
    {
        public JZQYCgxBudgetList()
        {
            InitializeComponent();
        }
        ...
        private void JZQYCgxBudgetList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void JZQYCgxBudgetList_SizeChanged(object sender, EventArgs e)
        {
