...
{
    public partial class JZQYEmployeeList : Form
    {
        public JZQYEmployeeList()
        {
            InitializeComponent();
        }
        ...
        private void JZQYEmployeeList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void JZQYEmployeeList_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string str = "select id,[position] as 岗位名称, [reason] as 原因, [numberPeople] as 计划入职人数, [date] as 月份 ,state2 as 状态 from [dbo].[SalesPersonnelDetails] where date like '%" + dateTimePicker1.Text.Trim() + "%' and state = 1 and state2 = 1 and company = '荆州区域' order by date desc";
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (comboBox1.Text == "新增人员")
            {
                ...
                JZQYUpdateAddEmployee updateCGXBBudget = new JZQYUpdateAddEmployee();
            ...
            {
                string iId = dataGridView1.CurrentRow.Cells["id"].Value.ToString();
                JZQYUpdateReduceEmployee updateCGXBBudget = new JZQYUpdateReduceEmployee();
                updateCGXBBudget.id = iId;
                updateCGXBBudget.Username = Username;
                updateCGXBBudget.Group = Group;
                updateCGXBBudget.ShowDialog();
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                ...
                cmd.CommandText = "update SalesPersonnelDetails set  state = -1 where id = '" + id + "'";
