...
{
    public partial class JZQYReduceEmployee : Form
    {
        public JZQYReduceEmployee()
        {
            InitializeComponent();
        }
        ...
        private void JZQYReduceEmployee_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void JZQYReduceEmployee_SizeChanged(object sender, EventArgs e)
        {
