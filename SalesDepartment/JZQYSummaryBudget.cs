...
{
    public partial class JZQYSummaryBudget : Form
    {
        public JZQYSummaryBudget()
        {
            InitializeComponent();
        }
        ...
        private void JZQYSummaryBudget_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void JZQYSummaryBudget_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id ,date as 时间 ,state as 状态 from SalesBudget where company = '荆州区域'";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                if (rq == date && zt == 1)
                {
                    ...
                    {
                        JZQYUpdateSummaryBudget updateCGXBBudget = new JZQYUpdateSummaryBudget();
