...
{
    public partial class JZQYSummaryBudgetList : Form
    {
        public JZQYSummaryBudgetList()
        {
            InitializeComponent();
        }
        ...
        private void JZQYSummaryBudgetList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void JZQYSummaryBudgetList_SizeChanged(object sender, EventArgs e)
        {
