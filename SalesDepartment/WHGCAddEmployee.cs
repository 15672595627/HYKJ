...
{
    public partial class WHGCAddEmployee : Form
    {
        public WHGCAddEmployee()
        {
            InitializeComponent();
        }
        ...
        private void WHGCAddEmployee_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WHGCAddEmployee_SizeChanged(object sender, EventArgs e)
        {
