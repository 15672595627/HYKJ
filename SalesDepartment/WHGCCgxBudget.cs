...
{
    public partial class WHGCCgxBudget : Form
    {
        public WHGCCgxBudget()
        {
            InitializeComponent();
        }
        ...
        private void WHGCCgxBudget_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WHGCCgxBudget_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id,date as 时间 ,state as 状态 from Salescgxys where company = '武汉工程'";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                if (rq == date && zt == 1)
                {
                    ...
                    {
                        WHGCUpdateCgxBudget updateCGXBBudget = new WHGCUpdateCgxBudget();
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[Salescgxys]([employee], [monthlySigningAmountPerEmployee], [signingTarget], [shippingTarget], [paymentTarget], [deposit ], [currentMonthShipmentReceipt], [collectionEarlyArrears], [refundAccounts],[date],[state],[company]) VALUES ('" + ygrs + "', '" + zyrj + "', '" + qdmb + "', '" + chmb + "', '" + hkmb + "', '" + dj + "', '" + bych + "', '" + sqqqk + "', '" + tgzk + "','" + date + "',1,'武汉工程')";
