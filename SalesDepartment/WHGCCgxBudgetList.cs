...
{
    public partial class WHGCCgxBudgetList : Form
    {
        public WHGCCgxBudgetList()
        {
            InitializeComponent();
        }
        ...
        private void WHGCCgxBudgetList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WHGCCgxBudgetList_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.SelectedRows.Count; i++)
            {
                ...
                cmd.CommandText = "update Salescgxys set  state = -1 where id = '" + id + "'";
