...
{
    public partial class WHGCEmployeeList : Form
    {
        public WHGCEmployeeList()
        {
            InitializeComponent();
        }
        ...
        private void WHGCEmployeeList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WHGCEmployeeList_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string str = "select id,[position] as 岗位名称, [reason] as 原因, [numberPeople] as 计划入职人数, [date] as 月份 ,state2 as 状态 from [dbo].[SalesPersonnelDetails] where date like '%" + dateTimePicker1.Text.Trim() + "%' and state = 1 and state2 = 1 and company = '武汉工程' order by date desc";
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (comboBox1.Text == "新增人员")
            {
                ...
                WHGCUpdateAddEmployee updateCGXBBudget = new WHGCUpdateAddEmployee();
