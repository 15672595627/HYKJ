...
{
    public partial class WHGCSummaryBudget : Form
    {
        public WHGCSummaryBudget()
        {
            InitializeComponent();
        }
        ...
        private void WHGCSummaryBudget_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WHGCSummaryBudget_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id ,date as 时间 ,state as 状态 from SalesBudget where company = '武汉工程'";
