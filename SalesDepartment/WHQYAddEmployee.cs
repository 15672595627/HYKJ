...
{
    public partial class WHQYAddEmployee : Form
    {
        public WHQYAddEmployee()
        {
            InitializeComponent();
        }
        ...
        private void WHQYAddEmployee_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WHQYAddEmployee_SizeChanged(object sender, EventArgs e)
        {
