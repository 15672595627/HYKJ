...
{
    public partial class WHQYCgxBudgetList : Form
    {
        public WHQYCgxBudgetList()
        {
            InitializeComponent();
        }
        ...
        private void WHQYCgxBudgetList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WHQYCgxBudgetList_SizeChanged(object sender, EventArgs e)
        {
