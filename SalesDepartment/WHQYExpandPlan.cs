...
{
    public partial class WHQYExpandPlan : Form
    {
        public WHQYExpandPlan()
        {
            InitializeComponent();
        }
        ...
        private void WHQYExpandPlan_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WHQYExpandPlan_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id, date as 时间 ,state as 状态 from SalesExpandPlan where state = 1 and company = '武汉区域'";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[SalesExpandPlan]([region], [province], [market], [county], [number], [yuefen], [target1], [target2], [remark], [date], [state],[company]) VALUES ('" + qy + "', '" + sf + "', '" + s + "', '" + qx + "', '" + rs + "','" + yf + "','" + qd + "','" + ch + "','" + bz + "','" + date + "','1','武汉区域')";
