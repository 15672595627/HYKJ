...
{
    public partial class WHQYFixedAssetBudget : Form
    {
        public WHQYFixedAssetBudget()
        {
            InitializeComponent();
        }
        ...
        DataTable dt;
        SqlDataAdapter da;
        private void WHQYFixedAssetBudget_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WHQYFixedAssetBudget_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select id,date as 时间,state as 状态 ,company as 公司 from SalesFixedAssetBudget where company = '武汉区域'";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                {    
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[SalesFixedAssetBudget]([apartment], [name], [purpose], [price], [number], [date],[state],[company]) VALUES ('" + bm + "', '" + xm + "', '" + yt + "', '" + dj + "', '" + sl + "', '" + date + "',1,'武汉区域')";
