...
{
    public partial class WHQYSummaryBudgetList : Form
    {
        public WHQYSummaryBudgetList()
        {
            InitializeComponent();
        }
        ...
        private void WHQYSummaryBudgetList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WHQYSummaryBudgetList_SizeChanged(object sender, EventArgs e)
        {
