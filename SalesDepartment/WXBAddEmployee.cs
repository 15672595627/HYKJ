...
{
    public partial class WXBAddEmployee : Form
    {
        public WXBAddEmployee()
        {
            InitializeComponent();
        }
        ...
        private void WXBAddEmployee_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WXBAddEmployee_SizeChanged(object sender, EventArgs e)
        {
