...
{
    public partial class WXBEmployeeList : Form
    {
        public WXBEmployeeList()
        {
            InitializeComponent();
        }
        ...
        private void WXBEmployeeList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WXBEmployeeList_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string str = "select id,[position] as 岗位名称, [reason] as 原因, [numberPeople] as 计划入职人数, [date] as 月份 ,state2 as 状态 from [dbo].[SalesPersonnelDetails] where date like '%" + dateTimePicker1.Text.Trim() + "%' and state = 1 and state2 = 1 and company = '网销区域' order by date desc";
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (comboBox1.Text == "新增人员")
            {
                ...
                WXBUpdateAddEmployee updateCGXBBudget = new WXBUpdateAddEmployee();
            ...
            {
                string iId = dataGridView1.CurrentRow.Cells["id"].Value.ToString();
                WXBUpdateReduceEmployee updateCGXBBudget = new WXBUpdateReduceEmployee();
                updateCGXBBudget.id = iId;
                updateCGXBBudget.Username = Username;
                updateCGXBBudget.Group = Group;
                updateCGXBBudget.ShowDialog();
