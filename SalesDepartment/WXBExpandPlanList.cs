...
{
    public partial class WXBExpandPlanList : Form
    {
        public WXBExpandPlanList()
        {
            InitializeComponent();
        }
        ...
        private void WXBExpandPlanList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WXBExpandPlanList_SizeChanged(object sender, EventArgs e)
        {
        ...
        {
            string str = "select id,date as 时间 , region as 区域 ,province as 省份 ,market as 市 ,county as 区县 ,number as 人数 ,yuefen as 人员到位月份 ,target1 as 签单目标,target2 as 收货目标 ,remark as 备注,state as 状态 from SalesExpandPlan where date like '%" + dateTimePicker1.Text.Trim() + "%' and state = 1 and company = '网销区域' order by date desc";
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            WXBUpdateExpandPlan updateCGXBBudget = new WXBUpdateExpandPlan();
