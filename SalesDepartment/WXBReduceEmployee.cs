...
{
    public partial class WXBReduceEmployee : Form
    {
        public WXBReduceEmployee()
        {
            InitializeComponent();
        }
        ...
        private void WXBReduceEmployee_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WXBReduceEmployee_SizeChanged(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string findSj = "select ID,date as 时间 ,state as 状态 from SalesPersonnelDetails where state = -1 and company = '网销区域'";
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
            {
                ...
                else
                {
                    ...
                    cmd.Connection = con;
                    cmd.CommandText = "INSERT INTO [dbo].[SalesPersonnelDetails]([position], [reason], [numberPeople], [date], [state],[state2],[company]) VALUES ('" + zw + "', '" + yy + "', '" + sl + "', '" + date + "', '-1',1,'网销区域')";
