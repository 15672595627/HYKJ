...
{
    public partial class WXBSummaryBudgetList : Form
    {
        public WXBSummaryBudgetList()
        {
            InitializeComponent();
        }
        ...
        private void WXBSummaryBudgetList_Load(object sender, EventArgs e)
        {
            asc.controllInitializeSize(this);
        }

        private void WXBSummaryBudgetList_SizeChanged(object sender, EventArgs e)
        {
