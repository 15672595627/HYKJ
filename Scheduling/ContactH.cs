...
namespace WindowsFormsApp1.Scheduling
{
    public partial class ContactH : Form
    {
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            CheckStock check = (CheckStock)this.Owner;
            check.Controls["groupBox1"].Controls["txtHtbh"].Text = a;
            check.Controls["groupBox1"].Controls["txtKh"].Text = c;
            check.Controls["groupBox1"].Controls["txtXm"].Text = d;
            this.Close();
        }
    } 
}
